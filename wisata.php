...
<div class="banner mb-5">
    <div class="container-fluid img">
        <div class="container-fluid box">
            <h3>WISATA</h3>
            <p>Home > <a href="#" class="titleBanner text-success">Wisata</a></p>
        </div>
    </div>
</div>
<div class="container mb-5">
    <div class="row text-center">
        <?php
                $query="SELECT * FROM tbl_artikel WHERE kategori='Wisata' LIMIT 3";
...
<div class="tengah mb-5">
    <div class="container">
        <div class="row text-left">
            <?php
                $query="SELECT * FROM tbl_artikel WHERE kategori='Wisata' ORDER BY Gambar asc LIMIT 1";
                $result=mysqli_query($db,$query);
                while ($data = mysqli_fetch_array($result)) {
                    $tgl = $data['tgl'];
            ?>
...
<div class="bawah">
    <div class="container ">
        ...
        <div class="row mb-3">
            <?php
                $query="SELECT * FROM tbl_artikel WHERE kategori='Wisata' ORDER BY id_artikel desc LIMIT 6";
                $result=mysqli_query($db,$query);
