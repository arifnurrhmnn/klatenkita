...
<body>
    <div class="signup-form">
        <form action="" method="post">
            ...
            <button class="btn btn-success btn-lg" name="login" id="submit">Login</button>
        ...
        {
            $ambil = $db->query("SELECT * FROM tbl_member WHERE username = '" . $_POST['u'] . "' AND password = '" . $_POST['p'] . "'");
            ...
            {
                echo "<script type='text/javascript'>swal('Login Gagal!', 'username dan password anda salah', 'warning');</script>";
            }
        }
        ?>
    </div>
